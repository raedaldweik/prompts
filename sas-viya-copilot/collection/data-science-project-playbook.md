...
- Define the **target** (what you're predicting/measuring) and the **unit of analysis** (per transaction? per supplier? per month?).
...
- Engineer features that encode domain knowledge (e.g. supplier share of category spend, days-to-award).
